...
class ProductionDetailsDataTable extends ConsumerStatefulWidget {
  const ProductionDetailsDataTable({
    super.key,
    required this.data,
  ...
  @override
  ConsumerState<ProductionDetailsDataTable> createState() =>
      _ProductionDetailsDataTableState();
}

class _ProductionDetailsDataTableState
    extends ConsumerState<ProductionDetailsDataTable> {
  @override
